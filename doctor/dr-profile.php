                                    ...
                                    <div class="card border-0 rounded-0 p-4">
                                        ...
                                        <div class="tab-content mt-2" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="overview-tab">
                                                <p class="text-muted"><?php echo $data['d_bio']; ?></p>
                                            
                                                <h6 class="mb-0">Specialties: </h6>
                                                <p><?php echo $data['d_speciality']; ?></p>
                                                            ...
                                                            <div class="p-4">
                                                                <div class="row align-items-center">
                                                                    <div class="col-lg-2 col-md-4">
                                                                        <img src="../assets/images/doctors_img/<?php echo $data['d_image']; ?>" class="avatar avatar-md-md rounded-pill shadow mx-auto d-block" alt="">
                                                                    </div><!--end col-->

                ...
                <div class="row mt-5 mt-lg-0">
                    <div class="col-12">
                        <div class="heading-title">
                            ...
                            <div class="mt-4 pt-2">
                                <a href="../patient/appointment" class="btn btn-primary">Make Appointment</a>
                                <!-- <p class="text-white-50 mb-0 mt-2">T&C apply. Please read <a href="#" class="text-white">Terms and Conditions <i class="ri-arrow-right-line align-middle"></i></a></p> -->
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                        <div class="ms-lg-4">
                            ...
                            <!-- <div class="mt-4">
                                <a href="aboutus" class="btn btn-primary">Read More <i class="ri-arrow-right-line align-middle"></i></a>
                            </div> -->
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2">
                        <div class="card team border-0 rounded shadow overflow-hidden">
                            ...
                            <div class="card-body content text-center">
                                <a href="doctor-team-one" class="title text-dark h5 d-block mb-0">Calvin Carlo</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="video-solution-cta position-relative" style="z-index: 1;">
                            <div class="position-relative">
                                <img src="images/blog/06.jpg" class="img-fluid rounded-md shadow-lg" alt="">
                                <div class="play-icon">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#watchvideomodal" class="play-btn video-play-icon">
        ...
        <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="me-lg-5">
                            <img src="images/svg/vaccine-development-amico.svg" class="img-fluid" alt="">
                        </div>
                    </div><!--end col-->
                ...
                <div class="row mt-4 pt-2 justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            ...
                            <a href="contact" class="btn btn-primary mt-4"><i class="mdi mdi-phone"></i> Contact us</a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div>

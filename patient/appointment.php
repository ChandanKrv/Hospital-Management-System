                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom py-3" style="min-width: 220px;">patient</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control patient-name select2input">
                    ...
                    <div class="modal-body py-5">
                        <div class="text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="para-desc mx-auto text-muted mb-0">Great patient if you need your family member to get immediate assistance, emergency treatment.</p>
                                <div class="mt-4">

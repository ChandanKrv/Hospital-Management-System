            ...
            <div class="col-lg-8 mt-4">
                <div class="card border-0 p-4 rounded shadow">
                    ...
                    <form class="mt-4" action="" method="post" enctype='multipart/form-data'>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="p_full_name" type="text" class="form-control" value="<?php echo $u_full_name ?>" >
                                </div>
                            </div>
                            <!--end col-->
                        ...
                        <button type="submit" name="adp_patient" class="btn btn-primary">Create patient Id</button>
                    </form>
                </div>
            </div>
            <!--end col-->

...
<div class="container-fluid">
    <div class="layout-specing">
        ...
        <section class="section" style="background: url('../index/images/bg/02.jpg') center center;padding:70px;">
                    ...
                    <div class="col-lg-5 offset-lg-7 col-md-7 offset-md-5">
                        <div class="features feature-bg-primary d-flex bg-white p-4 rounded-md shadow position-relative overflow-hidden">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-muted para mb-0">In this section patient can choose doctor and timings of appointment, if appointment slot is vacant.</p>
                            </div>
                            <div class="big-icon">
                        ...
                        <div class="features feature-bg-primary d-flex bg-white p-4 rounded-md shadow position-relative overflow-hidden mt-4">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="text-muted para mb-0">Here the patient can admit themselves by providing their details and selecting one doctor and staff of their choice. It will be admin's choice whether he/she will admit under that doctor.  </p>
                            </div>
                            <div class="big-icon">

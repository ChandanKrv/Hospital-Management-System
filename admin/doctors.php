                        ...
                        <div class="row row-cols-xl-5">
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Calvin Carlo</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Cristino Murphy</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Alia Reddy</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Toni Kovar</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Jessica McFarlane</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Elsie Sherman</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Bertha Magers</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Louis Batey</a>
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Julie Rosario</a>
                                        <small class="text-muted speciality">Psychotherapy</small>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-xl col-lg-4 col-md-6 mt-4">
                                <div class="card team border-0 rounded shadow overflow-hidden">
                                    ...
                                    <div class="card-body content text-center">
                                        <a href="dr-profile" class="title text-dark h5 d-block mb-0">Scott Guzman</a>

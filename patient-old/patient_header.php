...
<head>
    <meta charset="utf-8" />
    <title>HMS- patient Appointment Booking System</title>
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                ...
                <ul class="sidebar-menu pt-3">
                    ...
                    <li><a href="components.html"><i class="uil uil-cube me-2 d-inline-block"></i>patient</a></li>
            ...
            <div class="top-header">
                <div class="header-bar d-flex justify-content-between border-bottom">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="list-inline-item mb-0 ms-1">
                            <div class="dropdown dropdown-primary">
                                <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/doctors_img/<?php echo $data['p_image'] ?>" class="avatar avatar-ex-small rounded-circle" alt=""></button>
                                <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                    <a class="dropdown-item d-flex align-items-center text-dark" href="patient-profile">
                                        <img src="../assets/images/doctors_img/<?php echo $data['p_image'] ?>" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                        <div class="flex-1 ms-2">
                                            <span class="d-block mb-1">Dr.<?php echo $u_full_name ?></span>
                                            <small class="text-muted"><?php echo $data['p_department'] ?></small>
                                        </div>
                                    </a>
                                    ...
                                    <a class="dropdown-item text-dark" href="patient-profile"><span class="mb-0 d-inline-block me-1"><i class="uil uil-setting align-middle h6"></i></span> Profile Settings</a>
